categories ={
    ...
    singleCategoryCourse:function(singleCourse){
        ...
        //html+='</div>'+((!singleCourse.hasCourse)?'<a href="register.html" class="button pull-left">اشترك الان</a>':'')+'<div class="price"><h5>'+singleCourse.ksa_price+'$</h5></div></div></div>';
    ...
    singleCategoryWebinars:function(singleWebinar,isExpired){
        ...
        html+='</div><div class="views-count"><i class="fa fa-eye"></i>'+singleWebinar.view+'</div>'+((isExpired)?'<a href="register.html" class="button btn-block text-center subscriptions-button">اشترك الان</a>':'')+'</div></div>';
        return html;
    },
    singleCategorySuccesstories:function(singleStory,isExpired){
        ...
        html+='</div><div class="views-count"><i class="fa fa-eye"></i>'+singleStory.view+'</div>'+((isExpired)?'<a href="register.html" class="button btn-block text-center subscriptions-button">اشترك الان</a>':'')+'</div></div>';
        return html;
    },
    ...
    singleCategoryWorkShops:function(singleWorkShop,isExpired){
        ...
        html+='</div><div class="views-count"><i class="fa fa-eye"></i>'+singleWorkShop.view+'</div>'+((isExpired)?'<a href="register.html" class="button btn-block text-center subscriptions-button">اشترك الان</a>':'')+'</div></div>';
        return html;
    },
    coursesByCat:function(singleCategory,isExpired){
        ...
        // html+='</div><div class="price"><h5>'+singleCategory.course_section.ksa_price+'$</h5></div></div></div>';
        html+='</div><div class="views-count"><i class="fa fa-eye"></i>'+singleCategory.view+'</div>'+((isExpired)?'<a href="register.html" class="button btn-block text-center subscriptions-button">اشترك الان</a>':'')+'</div></div>';
