diplomas ={
    ...
    coursesSingleDiv:function(singleCourse){
        ...
        html+='</div><div class="pull-right"><i class="fa fa-eye"></i>'+singleCourse.view+'</div>'+((!singleCourse.hasDiploma)?'<a href="subscriptions.html" class="button pull-left">اشترك الان</a>':'')+'</div></div>';
        return html;
    },
