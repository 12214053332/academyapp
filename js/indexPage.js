indexPage={
    ...
    makeDiplomasSection:function(diplomas){
        ...
        diplomas.forEach(function(singleDiploma){
            ...
            html+='</div><div class="views-count"><i class="fa fa-eye"></i>'+singleDiploma.view+'</div>'+((!singleDiploma.hasDiploma)?'<a href="register.html" class="button  btn-block text-center subscriptions-button">اشترك الان</a>':'')+'</div></div>';
        });
