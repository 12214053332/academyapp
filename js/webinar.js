webinar ={
    ...
    coursesSingleDiv:function(singleCourse,isExpired){
        ...
        html='<div class="col s6 single-webinar"><div class="entry"><img src="'+APIURL+singleCourse.image+'" alt=""><h6><a data-id="'+singleCourse.id+'" href="#">'+singleCourse.name+'</a></h6><div class="rating">';
