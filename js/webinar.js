webinar ={
    ...
    coursesSingleDiv:function(singleCourse,isExpired){
        ...
        html+='</div><div class="views-count"><i class="fa fa-eye"></i>'+singleCourse.view+'</div>'+((isExpired)?'<a href="register.html" class="button btn-block text-center subscriptions-button">سجل الآن</a>':'')+'</div></div>';
        return html;
    },
